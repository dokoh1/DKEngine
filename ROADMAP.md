...
## Phase 4 — 렌더링 추상화 계층 (엔진다워지기)

**목표**: Phase 2~3의 절차적 코드를 재사용 가능한 클래스로 리팩터링한다. 이후 모든 단계의 토대.
...
**완료 기준**: Phase 3 삼각형을 새 추상화 API만으로 다시 그릴 수 있고, 코드 중복이 제거된다.
...
- [ ] Phase 0 — 도구 설치 (VS2022, Win SDK, PIX) & 빈 프로젝트 생성
- [ ] Phase 1 — Win32 윈도우 & 메시지 루프
- [ ] Phase 2 — D3D12 초기화 (화면 클리어)
- [ ] Phase 3 — 첫 삼각형
- [ ] Phase 4 — 렌더링 추상화 계층
- [ ] Phase 5 — 텍스처 & 리소스 업로드
